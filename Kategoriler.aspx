<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kategoriler.aspx.cs" Inherits="WebFood1.Admin.Kategoriler" %>
                            ...
                            <div class="col-md-5">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <asp:Label CssClass="col-sm-2 control-label" Text="Kategori Adı" runat="server" />
                                        <div class="col-sm-10">
                                            <asp:TextBox ID="txtKategoriEkle" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <asp:Label CssClass="col-sm-2 control-label" Text="Resim Ekle" runat="server" />
                                        <div class="col-sm-10">
                                            <asp:FileUpload ID="FileUploadKategoriResim" runat="server" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-10">
                                            <asp:Button CssClass=" btn btn-primary bg-primary" Text="Ekle" ID="btnEkle" runat="server" OnClick="btnEkle_Click" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="KategoriGuncelle.aspx?Kategoriid=<%#Eval("Kategoriid")%>">
                                                        <img alt="" src="../Content/AdminPanelContent/update.png" />
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="Kategoriler.aspx?Kategoriid=<%#Eval("Kategoriid")%>&islem=sil">
                                                        <img alt="" src="../Content/AdminPanelContent/delete.png" />
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
