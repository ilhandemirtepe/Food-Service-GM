<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BasinDetay.aspx.cs" Inherits="WebFood1.Musteri.BasinDetay" %>
                        ...
                        <div class="slider">
                            <div class="Hizmet">
                                <div class="wrapper" style="font-family: Cambria; color: #000000">
                                    <div class="myform">
                                        <asp:DataList ID="datalistBasinGetir" RepeatDirection="Horizontal" RepeatColumns="4" runat="server">
                                            <ItemTemplate>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Image ID="Image1" CssClass="resim" runat="server" ImageUrl='<%# Eval("DuyuruResim") %>' /></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        <td>
                                                            <table style="margin-left:30px;">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label  CssClass="Kategori1" ID="lblkadi" Text='<%# Eval("DuyuruBaslik") %>' runat="server" /> <br />

                                                                        <asp:Label CssClass="Kategori" ID="Label1" Text='<%# Eval("DuyuruIcerik") %>' runat="server" />
