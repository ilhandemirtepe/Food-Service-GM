<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Anasayfa.aspx.cs" Inherits="WebFood1.Anasayfa" %>
                    ...
                    <div class="wrapper">
                        ...
                        <nav>
                            <ul id="menu">
                                ...
                                <li><a href="Musteri/Hakkimiz.aspx">Hakkımızda</a></li>
                                 <li><a href="Musteri/Urunler.aspx">Ürünlerimiz</a></li>
                                <li><a href="Musteri/Hizmet.aspx">Servis-Hizmet</a></li>
                                <li><a href="Musteri/Basin.aspx">Basın</a></li>
                                <li><a href="Musteri/iletisim.aspx">İletişim</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="slider_bg">
                        <div class="slider">
                            <ul class="items">
                                <li></li>
                                <li>
                                    <img src="../Content/images/deneme1.jpg" alt="" /></li>
                                <li>
                                    <img src="../Content/images/deneme2.jpg" alt="" /></li>
