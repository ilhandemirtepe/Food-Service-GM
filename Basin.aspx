<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Basin.aspx.cs" Inherits="WebFood1.Musteri.Basin" %>
                    ...
                    <div class="wrapper">
                        ...
                        <nav>
                            <ul id="menu">
                                ...
                                <li class="active"><a href="Basin.aspx">Basın</a></li>
                        ...
                        <div class="slider">
                            <div class="Hizmet">
                                <div class="wrapper" style="font-family: Cambria; color: #000000">
                                    <div class="myform">
                                        <asp:DataList ID="DataList1" RepeatColumns="2" RepeatDirection="Horizontal" runat="server" Width="100%">
                                            <ItemTemplate>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <a href="BasinDetay.aspx?Duyuruid=<%#Eval("Duyuruid")%>">
                                                                        <asp:Image ID="Image1" ImageUrl='<%# Eval("DuyuruResim") %>' CssClass="resim" runat="server" />
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <a href="BasinDetay.aspx?Duyuruid=<%#Eval("Duyuruid")%>">
                                                                            <asp:Label CssClass="Kategori" Text='<%# Eval("DuyuruBaslik") %>' runat="server" />

                                                                        </a>

                                                                        <asp:Label CssClass="Tarih" Text='<%# Eval("DuyuruTarih") %>' runat="server" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
