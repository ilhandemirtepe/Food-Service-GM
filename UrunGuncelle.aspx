<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UrunGuncelle.aspx.cs" Inherits="WebFood1.Admin.UrunGuncelle" %>
                ...
                <div class="col-md-6">
                    <div class="form-horizontal">
                        <div class="form-group">
                            <asp:Label CssClass="col-sm-2 control-label" Text="Kategori Seç" runat="server" />
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <asp:Label CssClass="col-sm-2 control-label" Text="Ürün Adı" runat="server" />
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtUrunAdi" runat="server" />
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label CssClass="col-sm-2 control-label" Text="Resim Seç" runat="server" />
                            <div class="col-sm-10">
                               
                                <asp:FileUpload ID="FileUploadResimEkle" runat="server" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:Button CssClass=" btn btn-primary bg-primary" Text="Kaydet" ID="btnGuncelle" runat="server" OnClick="btnGuncelle_Click"  />
                                <asp:Label CssClass="control-label" ID="labelSonuc" runat="server" />
                            </div>
                        </div>
                    </div>
