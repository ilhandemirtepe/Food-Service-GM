<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Urunler.aspx.cs" Inherits="WebFood1.Musteri.Urunler" %>
                        ...
                        <div class="slider">
                            <div class="Hizmet">
                                <div class="wrapper" style="font-family: Cambria; color: #000000">
                                    <div class="myform">
                                        <asp:DataList ID="datalistKategoriGetir" RepeatDirection="Horizontal" RepeatColumns="5" Width="100%" runat="server">
                                            <ItemTemplate>
                                                <a href="KategoriDetay.aspx?Kategoriid=<%#Eval("Kategoriid")%>">
                                                    <asp:Image ID="Image1" CssClass="resim" runat="server" ImageUrl='<%# Eval("KategoriResim") %>' />
                                                </a>
                                                <br />
                                                <br />

                                                <%-- <a href="KategoriDetay.aspx?Kategoriid=<%#Eval("Kategoriid")%>" --%>
                                                <asp:Label CssClass="Kategori" ID="lblkadi" Text='<%# Eval("KategoriAdi") %>' runat="server" />
                                                <%--  </a>--%>
