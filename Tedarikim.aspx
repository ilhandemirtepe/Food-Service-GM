<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tedarikim.aspx.cs" Inherits="WebFood1.Musteri.Tedarikim" %>
                    ...
                    <div class="slider_bg">
                        <div class="slider">
                            <div class="Hizmet">
                                ...
                                <div style="margin-left: 400px;"><b style="color: darkgoldenrod;">Tedarikçi Formu</b>  </div>
                                            ...
                                            <td>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>Kurum Adı </td>
                                                        <td>
                                                            <asp:TextBox CssClass="textBoxlarim" ID="txtKurumAdi" placeholder="kurumunuzun adını yazınız" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Adres </td>
                                                        <td>
                                                            <asp:TextBox TextMode="MultiLine" CssClass="textBoxlarim" ID="txtAdres" placeholder="adresinizi yazınız" runat="server" Height="96px" Width="184px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:DropDownList ID="dropdownlistUrunGrubu" CssClass="textBoxlarim" runat="server">
                                                            </asp:DropDownList>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td>
                                                            <asp:Button Text="Gönder" ID="btnTedarikEklemeyap" OnClick="btnTedarikEklemeyap_Click" CssClass="buttonGonder" runat="server" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
