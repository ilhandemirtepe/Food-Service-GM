<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Haber.aspx.cs" Inherits="WebFood1.Admin.Haber" %>
                            ...
                            <div class="col-md-5">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <asp:Button CssClass=" btn btn-primary bg-primary" Text="Ekle" ID="btnHaberEkle1" runat="server" OnClick="btnHaberEkle1_Click"
                                                 />
                                    ...
                                    <ItemTemplate>
                                        <table class="table table-striped">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="HaberGuncelle.aspx?Duyuruid=<%#Eval("Duyuruid")%>">
                                                        <img alt="" src="../Content/AdminPanelContent/update.png" />
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="Haber.aspx?Duyuruid=<%#Eval("Duyuruid")%>&islem=sil">
